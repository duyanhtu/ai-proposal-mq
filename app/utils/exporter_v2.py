...
def fill_data_with_compliance(sheet, header_position, data: List[Dict[str, Any]]):
    """
    Điền dữ liệu vào sheet Excel
    """
    start_row = header_position["cell"].row + 1
    ...
    for idx, item in enumerate(data):
        ...
        # CELL TIME
        # COLUMN 7 BECAUSE OF compliance_confirmation
        cell_17 = sheet.cell(row=row_num, column=7)
        cell_17.value = f"{compliance_confirmation}"
...
def process_excel_file_no_upload(id: int, output_filename: str):
    """
